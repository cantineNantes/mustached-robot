...
class Form
{
	 ...
	 */
	public function addElementOnPublicCheckin($fieldname = 'reason', $before_after = 'after')
	{					
		\Lang::load('twitter::twitter.yml', 'twitter');
		return array('before_after' => $before_after, 'name' => 'twitter', 'label' => __('twitter.checkbox_label'), 'attributes' => array('type' => 'checkbox', 'value' => true), 'rules' => array(), 'fieldname' => $fieldname);
	}
